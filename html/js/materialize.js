...
function(i, n) {
    ...
    var t = {
        ...
        e = function() {
            ...
            return _createClass(s, [{
                ...
                value: function() {
                    ...
                    this.wasSwiped && (this.el.style.transition = "transform .05s, opacity .05s", this.el.style.transform = "translateX(" + e + "px)", this.el.style.opacity = 0), n({
                        ...
                        easing: "easeOutExpo",
                        complete: function() {
                            "function" == typeof t.options.completeCallback && t.options.completeCallback(), t.$el.remove(), s._toasts.splice(s._toasts.indexOf(t), 1), 0 === s._toasts.length 
                        }
                    })
                }
            }], [{
            ...
            // editado aqui tambem pra nao criar nada 
            {
                key: "_createContainer",
                value: function() {
                    var t = document.getElementById("phone-home-applications");
                    
                    t.setAttribute("id", "phone-home-applications"), t.addEventListener("touchstart", s._onDragStart), t.addEventListener("touchmove", s._onDragMove), t.addEventListener("touchend", s._onDragEnd), t.addEventListener("mousedown", s._onDragStart), document.addEventListener("mousemove", s._onDragMove), document.addEventListener("mouseup", s._onDragEnd), document.body.appendChild(t), s._container = t
                }
            }, 
            // editado aqui pra nao remover a tag
            // {
