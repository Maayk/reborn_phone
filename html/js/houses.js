    ...
    if (CurrentHouseData.keyholders !== undefined && CurrentHouseData.keyholders !== null) {
        $.each(CurrentHouseData.keyholders, function(i, keyholder){
            if (keyholder !== null && keyholder !== undefined) {
                var elem;
                if (keyholder.charinfo.firstname !== Reborn.Phone.Data.PlayerData.charinfo.firstname && keyholder.charinfo.lastname !== Reborn.Phone.Data.PlayerData.charinfo.lastname) {
...
$(document).on('click', '.house-key-delete', function(e){
    ...
    $.post('http://reborn_phone/RemoveKeyholder', JSON.stringify({
        HolderData: Data,
